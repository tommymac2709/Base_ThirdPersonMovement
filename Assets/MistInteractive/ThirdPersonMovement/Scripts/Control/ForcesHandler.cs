...
namespace MistInteractive.ThirdPerson.Control
{
    /// <summary>
    /// Component that applies external forces (e.g., knockback, jump) to a character.
    /// Integrates with CharacterController and optionally NavMeshAgent.
    /// </summary>

    public class ForcesHandler : MonoBehaviour
    {
